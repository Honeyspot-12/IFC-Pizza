  ...
  return (
    <>
      <div className='grid grid-cols-10 justify-between pl-3  bg-white py-3 text-[#868686] text-sm'>
          ...
          <div className=" flex-1 items-center  overflow-y-auto p-4  bg-[#f8f8f8]">
            {cart.length === 0 ? (
              ...
              cart.map((item) => (
                ...
                <div
                  key={item.id}
                  className="flex items-center justify-between  border-b border-[#A5A5A5]  font-medium "
                >
                  <div className='flex col-span-8 items-center justify-center gap-3'>
                    ...
                    <button className='md:border-b-2 cursor-pointer text-sm'
                      onClick={() => {
                  ...
                  <div className="flex  items-center justify-center space-x-2  text-right ">
                    <button
                    ...
                    <span className='px-2 bg-[#f8f8f8] border-1 border-[#A5A5A5] '>{item.qty}</span>
                    <button
