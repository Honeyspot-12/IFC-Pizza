  ...
  return (
    <div>
         <div className='flex'>
                ...
                <h3 className='text-black ml-2 mt-4 font-bold'>{floor}</h3>
            </div>
                    ...
                    <button
                        ...
                        className={`rounded-md cursor-pointer ${ 
                            table3.includes(num)
                                ...
                                :'bg-[#F7EFE8] text-[#A85916] border-1 border-[#A85916] border-dashed p-[18px] py-[28px] grid justify-center items-center'
                        } 
                        `
