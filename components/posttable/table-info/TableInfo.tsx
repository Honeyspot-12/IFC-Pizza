  ...
  return (
    ...
    <div className="xl:flex gap-3 grid grid-cols-2 md:grid-cols-1 justify-center md:justify-start items-center">
        <div className="relative">
            ...
            <button className="border border-[#A85916] flex items-center pl-7 pr-4 py-1.5 bg-[#A85916] text-white rounded-sm cursor-pointer text-[13px]">
                Table Reservation
            </button>
        </div>
    ...
    <div className="w-full md:w-auto">
        <ul className="xl:flex  grid grid-cols-3 justify-center md:justify-end gap-3 mt-2 md:mt-0 text-black text-[13px] font-medium">
