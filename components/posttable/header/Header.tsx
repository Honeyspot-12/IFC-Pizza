...
const Header = () => {
  ...
  return (
    ...
    <div className="flex  gap-3 px-1 sm:px-5 items-center justify-center sm:justify-start ">
        ...
        {/* Delivery Button */}
        <button className="border border-[#A85916] px-3 sm:px-5 bg-[#A85916] text-white rounded-sm py-1.5 text-[13px] cursor-pointer ">
            Delivery
        </button>
        ...
        <div className="relative flex items-center">
            ...
            <button
                className="border border-[#A85916] md:px-5 md:pl-7 bg-[#A85916] text-white rounded-sm py-1.5 text-[13px] cursor-pointer text-right"
